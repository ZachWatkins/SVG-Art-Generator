...
requirejs(['ui', 'svg', 'svgui'], function(ui, svg, svgui) {
		...
		for(var i=0; i<count; i++){
			...
			switch(orientation){
				...
				case 'horizontal':
					...
					break;
				case 'diagonal':
					var p1 = [getRandomIntInclusive(coordRange[0][0], coordRange[0][1]), getRandomIntInclusive(coordRange[1][0], coordRange[1][1])],
							p2 = [p1[0] + 10, getRandomIntInclusive(coordRange[1][0], coordRange[1][1])];
			...
			var diff = parseInt(ui.lines.max_width.value) - parseInt(ui.lines.min_width.value);
	...
	var refreshCircles = function(){
		...
		for(var i=0; i<count; i++){
			...
			var x = getRandomIntInclusive(coordRange[0][0], coordRange[0][1]);
			var y = getRandomIntInclusive(coordRange[1][0], coordRange[1][1]);
			var r = getRandomIntInclusive(ui.circles.min_radius.value, ui.circles.max_radius.value);
	...
	var refreshSquares = function(){
		...
		for(var i=0; i<count; i++){
			...
			var x = getRandomIntInclusive(coordRange[0][0], coordRange[0][1]);
			var y = getRandomIntInclusive(coordRange[1][0], coordRange[1][1]);
			var d = getRandomIntInclusive(ui.squares.min_width.value, ui.squares.max_width.value);
