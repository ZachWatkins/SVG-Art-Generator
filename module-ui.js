define('ui', ['svg'], function (svg) {
	...
	var ui = {
		...
		saveEvent: function(e){
			...
			var svgstring = '<?xml version="1.0" encoding="utf-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
	...
	ui.updateLineWidths = function(e){
		var lines = svg.el.getElementsByTagName('line'),
				diff = parseInt(this.lines.max_width.value) - parseInt(this.lines.minwidth.value);
	...
	ui.addEvents = function(){	
		...
		this.canvas.height.addEventListener('keyup', this.setSVGDimensions.bind(this));
		this.close.addEventListener('click', this.closeForm.bind(this));
		this.lines.count.addEventListener('change', this.updateDiagonalValues.bind(this));
		this.lines.max_width.addEventListener('change', this.updateLineWidths.bind(this));
