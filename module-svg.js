define('svg', function () {
	...
	svg.mouseDown = function(e){
		...
		this.mouse.timer = window.setTimeout(this.mouse.mode.func.bind(this), this.click.delay);
	...
	svg.mouseOut = function(e){
		...
		if(e.clientX > boundary.right || e.clientX < boundary.left || e.clientY < boundary.top || e.clientY > boundary.bottom){
	...
	svg.init = function(){
		...
		this.el.style.cssText = 'position:absolute;z-index:999;background-color:rgba(255,255,255,0.9);';
